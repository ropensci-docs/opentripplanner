...
- mode:
  ...
  WALK, BICYCLE, CAR, BUS, RAIL, SUBWAY, TRAM, FERRY, default CAR. Not
  all combinations are valid e.g. c("WALK","BUS") is valid but
  c("WALK","CAR") is not.
...
Other analyst:
[`otp_traveltime()`](https://docs.ropensci.org/opentripplanner/reference/otp_traveltime.md)
